defmodule ChatBot.SubprocessRegistry do
  @moduledoc """
  ...
  def handle_call({:register_subprocess, type, subprocess_id, pid}, _from, state) do
    ...
    case Registry.register(ChatBot.SubprocessRegistry, key, pid) do
      {:ok, _} ->
  ...
  def handle_call({:unregister_subprocess, type, subprocess_id}, _from, state) do
    ...
    Registry.unregister(ChatBot.SubprocessRegistry, key)
  ...
  def handle_call({:get_subprocess, type, subprocess_id}, _from, state) do
    ...
    case Registry.lookup(ChatBot.SubprocessRegistry, key) do
      [{_key, pid}] ->
        {:reply, {:ok, pid}, state}
