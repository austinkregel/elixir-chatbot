defmodule ChatBot.ML.Trainer do
  @moduledoc """
  ...
  alias ChatBot.ML.{DataLoaders, Tokenizer, EntityTrainer}
  ...
  def load_training_data_legacy do
    intents_path = Path.join(Application.get_env(:chat_bot, :ml)[:training_data_path], "intents")
