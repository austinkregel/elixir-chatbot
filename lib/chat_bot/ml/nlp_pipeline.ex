defmodule ChatBot.ML.NLPPipeline do
  @moduledoc """
  ...
  alias ChatBot.ML.{EntityExtractor, IntentClassifierSimple, Gazetteer, Tokenizer}
  ...
  defp get_confidence_threshold do
    Application.get_env(:chat_bot, :ml)[:confidence_threshold] || 0.75
  end
