defmodule ChatBot.Learning.WorldContext do
  @moduledoc """
  ...
  def add_episode(world_id, state, action, outcome, tags) do
    ...
    ChatBot.Memory.Store.add_episode(state, action, outcome, tags, world_id: world_id)
  end
  ...
  def add_knowledge(world_id, category, key, value) do
    ChatBot.KnowledgeStore.add_to_world(world_id, category, key, value)
  end
  ...
  defp get_world_knowledge_direct(world_id, category) do
    case ChatBot.KnowledgeStore.get_world_knowledge(world_id, category) do
  ...
  defp query_world_similar(world_id, text, k) do
    ChatBot.Memory.Store.query_similar(text, k, world_id: world_id)
  end

  defp classify_with_world_model(world_id, text) do
    ChatBot.ML.IntentClassifierSimple.classify(text, world_id: world_id)
  end
