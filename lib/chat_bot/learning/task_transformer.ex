defmodule ChatBot.Learning.TaskTransformer do
  @moduledoc """
  ...
  alias ChatBot.ML.{Tokenizer, POSTagger, EntityExtractor}
  ...
  def transform_task(file_path, opts \\ []) do
    ...
    # Parse task metadata
    case TaskAnalyzer.parse_task_file(file_path) do
      nil ->
        {:error, :parse_failed}

      metadata ->
        # Load instances
        case TaskAnalyzer.load_instances(file_path,
