defmodule ChatBot.Subprocesses.HttpSubprocess do
  @moduledoc """
  ...
  def terminate(reason, state) do
    ...
    if state.http_server do
      DynamicSupervisor.terminate_child(ChatBot.Subprocesses.Supervisor, state.http_server)
    end
  ...
  defp via_tuple(subprocess_id) do
    {:via, Registry, {ChatBot.SubprocessRegistry, {:http_subprocess, subprocess_id}}}
  end
