defmodule ChatBot.Subprocesses.Supervisor do
  @moduledoc """
  ...
  def start_http_subprocess(opts \\ []) do
    ...
    child_spec =
      {ChatBot.Subprocesses.HttpSubprocess,
       [
  ...
  def start_conversation_subprocess(opts \\ []) do
    ...
    child_spec =
      {ChatBot.Subprocesses.ConversationSubprocess,
       [
         subprocess_id: subprocess_id,
  ...
  def start_cli_subprocess(opts \\ []) do
    ...
    child_spec =
      {ChatBot.Subprocesses.CliSubprocess,
       [
         subprocess_id: subprocess_id,
         memory_snapshot: memory_snapshot
       ]}
