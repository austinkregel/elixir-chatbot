defmodule ChatBot.Analysis.ParallelPipeline do
  @moduledoc """
  ...
  alias ChatBot.Analysis.Pipeline, as: AnalysisPipeline
  alias ChatBot.Summarization.Pipeline, as: SummarizationPipeline
