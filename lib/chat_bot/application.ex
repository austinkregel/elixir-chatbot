defmodule ChatBot.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      # HeuristicStore loads seeded heuristics from data/ (source of truth generated by scripts/generate_heuristics.py)
      {ChatBot.Analysis.HeuristicStore, seeded_path: "data/heuristics/seeded_heuristics.json"},
      ...
      # Start the Chunk Compatibility system (for template blending)
      ChatBot.Response.ChunkCompatibility,
      # Start the Template Blender (generates novel responses from chunks)
      ChatBot.Response.TemplateBlender,
      # Start the Semantic Fact Retriever (TF-IDF based fact search)
      ChatBot.Response.SemanticFactRetriever,
