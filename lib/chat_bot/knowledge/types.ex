defmodule ChatBot.Knowledge.Types do
  ...
  defmodule Hypothesis do
    ...
    alias ChatBot.Knowledge.Types.Finding
  ...
  defmodule Investigation do
    ...
    alias ChatBot.Knowledge.Types.{Hypothesis, Finding}
  ...
  defmodule ResearchGoal do
    ...
    alias ChatBot.Knowledge.Types.{Hypothesis, Investigation}
  ...
  defmodule LearningSession do
    ...
    alias ChatBot.Knowledge.Types.{ResearchGoal, Investigation}
