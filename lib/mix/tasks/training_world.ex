  ...
  def run(args) do
    ...
    case rest do
      [name] ->
        ...
        case ChatBot.Learning.WorldManager.create(name, mode: mode) do
          {:ok, world} ->
    ...
    case rest do
      [world_id, pattern] ->
        ...
        if length(files) == 0 do
          ...
          case ChatBot.Learning.DocumentIngestor.ingest_files(world_id, files, ingest_opts) do
            {:ok, result} ->
              Mix.shell().info("")
  ...
  def run(args) do
    case args do
      [world_id] ->
        ...
        case ChatBot.Learning.WorldManager.get_metrics(world_id) do
          {:ok, metrics} ->
            summary = ChatBot.Learning.WorldMetrics.summary(metrics)
  ...
  def run(args) do
    case args do
      [world_id_1, world_id_2] ->
        ...
        case ChatBot.Learning.WorldManager.compare(world_id_1, world_id_2) do
          {:ok, diff} ->
  ...
  def run(args) do
    ...
    case rest do
      [world_id] ->
        ...
        case ChatBot.Learning.WorldManager.export(world_id) do
          {:ok, data} ->
  ...
  def run(args) do
    ...
    case rest do
      [source_id, target_id] ->
        ...
        case ChatBot.Learning.WorldManager.merge(source_id, target_id, merge_opts) do
          {:ok, count} ->
...
defmodule Mix.Tasks.TrainingWorld.List do
  ...
  def run(_args) do
    ...
    active_worlds = ChatBot.Learning.WorldManager.list_worlds()

    # List persisted worlds (on disk)
    persisted_worlds = ChatBot.Learning.WorldPersistence.list_persisted_worlds()
  ...
  def run(args) do
    case args do
      [world_id] ->
        ...
        case ChatBot.Learning.WorldManager.destroy(world_id) do
          :ok ->
  ...
  def run(args) do
    case args do
      [world_id] ->
        ...
        case ChatBot.Learning.WorldManager.checkpoint(world_id) do
          :ok ->
  ...
  def run(args) do
    case args do
      [world_id] ->
        ...
        case ChatBot.Learning.WorldManager.load_world(world_id) do
          {:ok, world} ->
