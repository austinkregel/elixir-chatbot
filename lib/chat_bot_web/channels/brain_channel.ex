defmodule ChatBotWeb.BrainChannel do
  ...
  def handle_in("evaluate", %{"conversation_id" => conversation_id, "input" => input}, socket) do
    ...
    case ChatBot.Brain.evaluate(conversation_id, input) do
      {:ok, response} ->
  ...
  def handle_in("end_conversation", %{"conversation_id" => conversation_id}, socket) do
    ...
    case ChatBot.Brain.end_conversation(conversation_id) do
      :ok ->
  ...
  def handle_in("get_conversations", _payload, socket) do
    ...
    conversations = ChatBot.Brain.get_conversations()
  ...
  def handle_in("urgent_interrupt", %{"reason" => reason, "data" => data}, socket) do
    ...
    ChatBot.Brain.handle_urgent_interrupt(reason, data)
  ...
  def handle_in("urgent_emergency", %{"reason" => reason, "data" => data}, socket) do
    ...
    ChatBot.Brain.handle_urgent_emergency(reason, data)
