defmodule ChatBotWeb.Admin.KnowledgeReviewLive do
  @moduledoc """
  ...
  alias ChatBot.Knowledge.{ReviewQueue, LearningCenter}
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      Phoenix.PubSub.subscribe(ChatBot.PubSub, "knowledge:review")
  ...
  def render(assigns) do
    ...
    <div class="container mx-auto p-4 max-w-6xl">
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Knowledge Review Queue</h1>
        <button
