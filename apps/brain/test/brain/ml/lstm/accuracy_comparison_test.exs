defmodule Brain.ML.LSTM.AccuracyComparisonTest do
  ...
  @confusable_cases [
    ...
    {"what can you tell me about yourself", "smalltalk.agent.acquaintance"},
    ...
    {"turn on the lights", "smarthome.lights.switch"},
    {"turn off the living room light", "smarthome.lights.switch"}
  ]
