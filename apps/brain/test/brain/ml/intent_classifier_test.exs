defmodule Brain.ML.IntentClassifierTest do
  use ExUnit.Case, async: false

  import ExUnit.CaptureLog

  alias Brain.ML.IntentClassifier
  ...
  describe "load_models/0" do
    ...
    test "returns error when files are missing" do
      # Use :brain config namespace (brain app owns ML config)
      original_config = Application.get_env(:brain, :ml)
      ...
      on_exit(fn ->
        Application.put_env(:brain, :ml, original_config)
      end)
