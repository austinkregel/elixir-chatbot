defmodule Brain.Response.PrimitiveTypes do
  ...
  @content_variants [:factual, :explanatory, :reflective, :narrative, :creative, :action_result, :report, :enriched]
  ...
  # Answering an order: what was asked about, reported back to whoever asked.
  def required_content(:content, :report), do: [:topic]
