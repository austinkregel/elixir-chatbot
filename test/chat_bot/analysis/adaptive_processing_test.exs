defmodule ChatBot.Analysis.AdaptiveProcessingTest do
  @moduledoc """
  ...
  describe "BacktrackController" do
    ...
    test "checks for contradictions" do
      ...
      interp =
        ...
        |> Interpretation.with_slots(%ChatBot.Analysis.SlotResult{
      ...
      ok_interp =
        ...
        |> Interpretation.with_slots(%ChatBot.Analysis.SlotResult{all_required_filled: true})
  ...
  describe "HeuristicStore" do
    ...
    test "matches global heuristics" do
      case HeuristicStore.match_best("Hello there!", nil, nil) do
    ...
    test "respects scope activation caps" do
      # Add heuristics at different scopes
      {:ok, global} =
        HeuristicStore.add_heuristic(
