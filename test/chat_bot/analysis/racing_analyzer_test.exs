defmodule ChatBot.Analysis.RacingAnalyzerTest do
  use ExUnit.Case, async: false

  alias ChatBot.Analysis.{RacingAnalyzer, Interpretation, AnalyzerResult}
  ...
  describe "check_fast_path/3" do
    ...
    test "returns tuple structure when fast path fires" do
      ...
      result = RacingAnalyzer.check_fast_path("Hello", nil, nil)
