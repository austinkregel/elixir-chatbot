defmodule ChatBotWeb.Admin.KnowledgeReviewLiveTest do
  use ChatBotWeb.ConnCase, async: false
  import Phoenix.LiveViewTest
  import ChatBot.TestHelpers

  alias ChatBot.Knowledge.{ReviewQueue, SourceReliability, LearningCenter}
  alias ChatBot.Knowledge.Types.{Finding, SourceInfo, ReviewCandidate}

  setup do
    ensure_pubsub_started()

    # Start required GenServers
    case Task.Supervisor.start_link(name: ChatBot.Knowledge.AgentSupervisor) do
      {:ok, _pid} -> :ok
